    ...
    <div className="w-full h-[80px] bg-white">
      <div className="md:max-w-[1480px] max-w-[600px] m-auto  w-full h-full flex justify-between items-center ">
        ...
        <div className="hidden md:flex">
          <button className=" flex justify-between items-center bg-transparent px-6 gap-2 hover:cursor-pointer">
            <img src={lock} alt="" />
            Login
          </button>
          <button className="px-8 py-3 rounded-md bg-[#20B486] text-white font-bold hover:cursor-pointer">
            Sign-up For Free
          </button>
        </div>
