    ...
    <div className='w-full bg-white py-24'>
        <div className='md:max-w-[1480px] m-auto grid md:grid-cols-5 max-[780px]:grid-cols-2  gap-8 max-w-[600px]  px-4 md:px-0'>
            ...
            <div className='col-span-2'>
                ...
                <h3 className='py-2 text-[#6D737A]'>Call : +234 8104 2384 35</h3>
                <h3 className='py-2 text-[#6D737A]'> Call us now <br></br> Call us now to begin your tech journey with no Difficulty</h3>
                <h3 className='py-2 text-[#363A3D]'>Email: umarhayatudeen88@gmail.com</h3>
            ...
            <div className='max-[780px]:col-span-2'>
                ...
                <h3 className='py-2 text-[#6D737A]'>Don't miss out!  <br></br> Subscribe now for daily tech tips and exclusive newsletter content.</h3>
                <form className='py-4'>
                    <input 
